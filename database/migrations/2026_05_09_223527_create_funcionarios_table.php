...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('funcionarios', function (Blueprint $table) {
            ...
            $table->enum('tipo_contrato', ['clt', 'temporario', 'aprendiz', 'estagio', 'terceirizado']); // prazo/termo
            $table->enum('tipo_contratacao', ['clt', 'pj', 'terceirizado', 'temporario', 'estagio', 'aprendiz'])->default('clt'); // vinculo/regime
