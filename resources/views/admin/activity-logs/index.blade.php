                ...
                <tbody class="divide-y">
                    @forelse($logs as $log)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-xs text-gray-400">{{ class_basename($log->subject_type) }}
                                #{{ $log->subject_id }}</td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="5" class="px-4 py-12 text-center text-gray-400">Nenhum log encontrado.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
