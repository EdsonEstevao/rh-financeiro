    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Criar um novo perfil de acesso</p>
            </div>
        ...
        <form action="{{ route('admin.roles.store') }}" method="POST" class="bg-white rounded-lg shadow p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                    ...
                    placeholder="Ex: rh, financeiro, gerente" required>
                @error('name')
            ...
            <div>
                ...
                @foreach ($groupedPermissions as $module => $perms)
                    <div class="mb-4 border rounded-lg overflow-hidden" x-data="{ open: {{ $loop->first ? 'true' : 'false' }} }">
                        <button type="button" @click="open = !open"
                            ...
                            <span class="text-xs text-gray-400">{{ $perms->count() }} permissões</span>
                        </button>
