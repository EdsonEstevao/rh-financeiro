    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Criar um novo usuário no sistema</p>
            </div>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="bg-white rounded-lg shadow p-6 space-y-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700">Senha <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700">Confirmar Senha <span
