                                    ...
                                    <table class="min-w-full text-sm">
                                        ...
                                        <tbody class="divide-y">
                                            @foreach ($feriasDireito as $funcionario)
                                                ...
                                                @endphp
                                                <tr
                                                    class="hover:bg-gray-50 transition-colors {{ $statusAlertColors[$funcionario->status_alerta] }}">
                                                    <td class="px-4 py-3">
                                                        <div class="flex items-center gap-2">
                                                            <div
                                ...
                                <tbody class="divide-y">
                                    @foreach ($proximasFerias as $ferias)
                                        <tr class="transition-colors hover:bg-gray-50">
                                            ...
                                            <td class="px-4 py-3">
                                                <span
                                                    class="px-2 py-0.5 text-xs rounded-full font-medium {{ $statusColors[$ferias->status] }}">
                        ...
                        @if ($ultimasAtividades->count() > 0)
                            @php
                                $eventColors = [
                                    ...
                                    'deleted' => 'bg-red-100 text-blue-600',
                                    'acessou_resumo_folha' => 'bg-gray-100 text-gray-600',
                                ];
                            @endphp
                            <div class="space-y-3">
                                @foreach ($ultimasAtividades as $atividade)
                                    <div class="flex items-start gap-3 p-2 transition-colors rounded-lg hover:bg-gray-50">
                                        <div
                                            class="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 {{ $eventColors[$atividade->event] ?? 'bg-gray-100' }}">
