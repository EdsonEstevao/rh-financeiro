        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('rh.faixa-irrf.store') }}" x-data="{
                        faixas: [],
                        adicionarFaixa() {
                            this.faixas.push({
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="descricao" name="descricao" type="text" maxlength="255"
                                ...
                                placeholder="Ex: Tabela IRRF 2025" />
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <x-text-input id="deducao_dependente" name="deducao_dependente" type="number"
                                    ...
                                    value="{{ old('deducao_dependente', '189.59') }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="deducao_pensao" name="deducao_pensao" type="number" step="0.01"
                                    min="0" class="mt-1 block w-full" value="{{ old('deducao_pensao', '0.00') }}" />
                                ...
                                <table class="min-w-full divide-y divide-gray-200 border border-gray-200 rounded-lg">
                                    ...
                                    <tbody class="divide-y divide-gray-200">
                                        <template x-for="(faixa, index) in faixas" :key="index">
                                            <tr>
                                                <td class="px-4 py-3">
                                                    <x-text-input type="number" min="1" :name="'faixas[' + index + '][ordem]'"
                                                        x-model="faixa.ordem" class="block w-20" readonly />
                                                </td>
                                                <td class="px-4 py-3">
                                                    <x-text-input type="number" step="0.01" min="0"
                                                        :name="'faixas[' + index + '][teto]'" x-model="faixa.teto" placeholder="0,00"
                                                        required />
                                                </td>
                                                <td class="px-4 py-3">
                                                    <x-text-input type="number" step="0.0001" min="0"
                                                        max="1" :name="'faixas[' + index + '][aliquota]'" x-model="faixa.aliquota"
                                                        placeholder="0,0750" required />
                                                </td>
                                                <td class="px-4 py-3">
                                                    <x-text-input type="number" step="0.01" min="0"
                                                        :name="'faixas[' + index + '][deducao]'" x-model="faixa.deducao" placeholder="0,00" />
                                                </td>
