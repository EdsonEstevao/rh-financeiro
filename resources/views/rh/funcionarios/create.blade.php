        ...
        <form method="POST" action="{{ route('rh.funcionarios.store') }}">
            ...
            <div x-show="tab === 'contrato'" x-transition>
                <div class="p-6 space-y-8 bg-white rounded-lg shadow ring-1 ring-black/5">
                    ...
                    {{-- ============================================================ --}}
                    {{-- ABA 5: CONTRATO & SALÁRIO - ADICIONAR APÓS HORÁRIOS --}}
                    {{-- ============================================================ --}}
                                ...
                                @foreach ($diasSemana as $valor => $dia)
                                    <label
                                        ...
                                        <div class="flex flex-col items-center">
                                            <span class="text-xs font-bold" x-text="'{{ $dia['short'] }}'"></span>
...
@push('scripts')
    <script>
        ...
        // 🆕 Script dos dias de trabalho
        function diasTrabalhoForm() {
            return {
                // diasSelecionados: json(old('dias_trabalho', [1, 2, 3, 4, 5])) // Padrão: seg a sex
                diasSelecionados: {{ Js::from(old('dias_trabalho', [1, 2, 3, 4, 5])) }}
            };
        }
    </script>
@endpush
